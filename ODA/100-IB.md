...
## Lab 1: 动手体验CafeSupremo咖啡数字助理 ##

### 介绍 ###
CafeSupremo数字助理旨在吸引新客户，并允许现有客户与该品牌进行更个性化的互动。在这种情况下，潜在客户（Lucy露西）走在街上，想要喝一杯咖啡。 
<img src="img/lab1-intro-1.png" width="100%"/>

只需在她的移动浏览器（本实验室）中搜索CaféSupremo网页，或使用社交渠道（如微信），Lucy就可以访问他们的“虚拟咖啡师”并快速订购她所追求的饮料，并拥有当她到达最近的咖啡店时准备好了。
